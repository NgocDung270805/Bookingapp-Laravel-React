                  ...
                  <div class="row align-items-center gx-0 gy-7">
                    ...
                    <div class="col mx-auto">
                      <div class="auth-form-box">
                        ...
                        <form>
                          <div class="mb-3 text-start"><label class="form-label" for="name">Họ và tên<nav></nav></label><input class="form-control" id="name" type="text" placeholder="Vui lòng nhập họ và tên" /></div>
                          <div class="mb-3 text-start"><label class="form-label" for="email">Email</label><input class="form-control" id="email" type="email" placeholder="name@gmail.com" /></div>
                          ...
                          <div class="form-check mb-3"><input class="form-check-input" id="termsService" type="checkbox" /><label class="form-label fs-9 text-transform-none" for="termsService">Tôi chấp nhận 
                            <a href="#!">các điều khoản</a> và <a href="#!">chính sách bảo mật</a></label></div><button class="btn btn-primary w-100 mb-3">Đăng ký</button>
                          <div class="text-center"><a class="fs-9 fw-bold" href="../../../pages/authentication/card/sign-in.html">Đăng nhập vào tài khoản hiện có</a></div>
                        </form>
                      </div>
                    </div>
                  </div>
