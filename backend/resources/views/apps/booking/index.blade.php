@extends('layouts.app')
@section('title', 'Booking') {{-- Đổi tiêu đề thành Booking --}}
@section('content')
    <div class="content">
        <nav class="mb-3" aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active">List Booking</li> {{-- Đổi Category thành Tag --}}
            </ol>
        </nav>
        <div class="mb-9">
            <div class="row g-3 mb-4">
                <div class="col-auto">
                    <h2 class="mb-0">Bookings</h2> {{-- Đổi Categories thành Bookings --}}
                </div>
            </div>
            <ul class="nav nav-links mb-3 mb-lg-2 mx-n3">
                <li class="nav-item"><a class="nav-link active" aria-current="page" href="#"><span>All </span><span
                                ...
                                id="total-tags">({{ count($bookings) }})</span></a></li> {{-- Đổi total-categories thành total-tags, categories thành tags --}}
                    ...
                    <div class="d-flex flex-wrap gap-3">
                        ...
                        <div class="ms-xxl-auto"><button class="btn btn-link text-body me-4 px-0"><span
                            ...
                            {{-- <button class="btn btn-primary" id="addTagBtn" data-bs-toggle="modal"
                                ...
                                <span class="fas fa-plus me-2"></span>Add Bookings 
                            </button> --}}
                        </div>
                    </div>
                </div>
                                    ...
                                    <tr class="position-static">
                                        ...
                                        <td class="description align-middle review pb-2 ps-3" style="min-width:225px;">
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                @else
                                                    <span class="badge text-secondary">{{ ucfirst($booking->status) }}</span>
                                                @endif
                                            </div>
                                        </td>
                                        <td class="description align-middle review pb-2 ps-3" style="min-width:225px;">
