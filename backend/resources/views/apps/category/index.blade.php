    ...
    <div class="content">
        ...
        <div class="mb-9">
            <div class="row g-3 mb-4">
                <div class="col-auto">
                    <h2 class="mb-0">Categories</h2> {{-- Changed to Categories --}}
                </div>
            </div>
            <ul class="nav nav-links mb-3 mb-lg-2 mx-n3">
                <li class="nav-item"><a class="nav-link active" aria-current="page" href="#"><span>All </span><span
                            ...
                            id="total-categories">({{ count($categories) }})</span></a></li>
                {{-- Giữ các tab này nếu bạn vẫn muốn dùng, nhưng không liên quan trực tiếp đến chức năng Category CRUD hiện tại --}}
                    ...
                    <div class="d-flex flex-wrap gap-3">
                        ...
                        <div class="ms-xxl-auto"><button class="btn btn-link text-body me-4 px-0"><span
                            ...
                            <button class="btn btn-primary" id="addCategoryBtn" data-bs-toggle="modal"
                                data-bs-target="#categoryModal"> {{-- Thay đổi ID và thêm data-bs-target --}}
                                <span class="fas fa-plus me-2"></span>Add Category {{-- Thay đổi text --}}
                            </button>
                        </div>
                    </div>
                </div>
                <div
                    ...
                    <div class="table-responsive scrollbar mx-n1 px-1">
                        <table class="table fs-9 mb-0">
                            ...
                            <tbody class="list" id="products-table-body"> {{-- Giữ ID gốc --}}
                                @foreach ($categories as $category)
                                    <tr class="position-static">
                                        <td class="fs-9 align-middle">
                                            <div class="form-check mb-0 fs-8"><input class="form-check-input"
                                                    type="checkbox"
                                                    data-bulk-select-row='{"categoryId":{{ $category->id }}}' />
                                            </div>
                                        </td>
                                        ...
                                        <td class="description align-middle review pb-2 ps-3" style="min-width:225px;">
                                            {{ Str::limit($category->description, 50) }} {{-- Giới hạn độ dài mô tả --}}
                                        </td>
                                            ...
                                            <div class="btn-reveal-trigger position-static">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end py-2">
                                                    ...
                                                    <a class="dropdown-item text-danger delete-category-btn"
                                                        href="#" data-id="{{ $category->id }}">Remove</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
        ...
        @include('partials.footer') {{-- Đảm bảo partials.footer tồn tại --}}
    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function updateCategoryTable(categories) {
                ...
                function buildCategoryRows(categoriesData) {
                    categoriesData.forEach(category => {
                        ...
                        // let imageUrl = category.img ? `{{ asset('uploads/categories') }}/${category.img}` :
            ...
            function loadParentCategories(selectedParentId = null, excludeId = null) {
                $.ajax({
                    url: "{{ route('category.index') }}", // Tải lại tất cả danh mục để có thể chọn làm cha
                    method: 'GET',
            ...
            $('#categoryForm').on('submit', function(e) {
                ...
                let url = method === 'POST' ? "{{ route('category.store') }}" : `/category/${categoryId}`;
