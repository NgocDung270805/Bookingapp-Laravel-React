    ...
    <div class="content">
        <nav class="mb-3" aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item"><a href="<?php echo e(route('booking.index')); ?>">Booking</a></li>
        ...
        <div class="mb-9">
            ...
            <ul class="nav nav-links mb-3 mb-lg-2 mx-n3">
                <li class="nav-item"><a class="nav-link active" aria-current="page" href="#"><span>All </span><span
                                ...
                                id="total-tags">(<?php echo e(count($bookings)); ?>)</span></a></li> 
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="sort white-space-nowrap align-middle ps-4" scope="col"
                                        style="width:350px;" data-sort="tag-name">NGƯỜI ĐẶT</th> 
                                    ...
                                    <th class="sort align-middle ps-4" scope="col" data-sort="status"
                                        style="width:150px;">NGÀY ĐẶT</th> 
                                    <th class="sort align-middle ps-3" scope="col" data-sort="description"
                                        style="width:250px;">THỜI GIAN</th> 
                                    <th class="sort align-middle ps-3" scope="col" data-sort="description"
                                        style="width:250px;">TRẠNG THÁI</th> 
                                    <th class="sort align-middle ps-3" scope="col" data-sort="description"
                                        style="width:250px;">NOTE</th> 
                                ...
                                <?php $__currentLoopData = $bookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="position-static">
                                        ...
                                        <td class="description align-middle review pb-2 ps-3" style="min-width:225px;">
                                            <?php echo e(\Carbon\Carbon::parse($booking->booking_time)->format('H:i:s')); ?>
                                        ...
                                        <td class="description align-middle review pb-2 ps-3" style="min-width:225px;">
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <?php elseif($booking->status == 'completed'): ?>
                                                    <span class="badge text-info">Đã hoàn thành</span>
                                                <?php else: ?>
                                                    <span class="badge text-secondary"><?php echo e(ucfirst($booking->status)); ?></span>
                                                <?php endif; ?>
                                            </div>
                                        </td>
                                        <td class="description align-middle review pb-2 ps-3" style="min-width:225px;">
                                            <?php echo e($booking->notes ?? 'N/A'); ?>
                                            ...
                                            <div class="btn-reveal-trigger position-static">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end py-2">
                                                    <a class="dropdown-item edit-tag-btn" href="#"
                                                        data-id="<?php echo e($booking->id); ?>">Edit</a> 
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.edit-tag-btn', function() {
                ...
                $.ajax({
                    url: `/bookings/${id}/edit`, // Sử dụng route bookings
                    method: 'GET',
                    success: function(response) {
                        console.log("Ajax success for edit tag:", response); // Thêm log
                        let bookings = response.booking;

                        $('#tagName').val(bookings.id);
                        // Không có description, img, status, parent_id cho bookings
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\BookingApp–Laravel-React\backend\resources\views/apps/booking/index.blade.php ENDPATH**/ ?>