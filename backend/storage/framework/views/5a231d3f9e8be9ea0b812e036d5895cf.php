        ...
        <div class="navbar-vertical-content">
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
                    ...
                    <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-home"
                        ...
                        <div class="parent-wrapper label-1">
                            <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse"
                                ...
                                <li class="nav-item"><a class="nav-link active" href="<?php echo e(route('home')); ?>">
                ...
                <li class="nav-item">
                    ...
                    <div class="nav-item-wrapper">
                        <a class="nav-link label-1" href="<?php echo e(route('category.index')); ?>" role="button" data-bs-toggle="" aria-expanded="false">
                            <div class="d-flex align-items-center">
                                <span class="nav-link-icon">
                    ...
                    <div class="nav-item-wrapper">
                        <a class="nav-link label-1" href="<?php echo e(route('tag.index')); ?>" role="button" data-bs-toggle="" aria-expanded="false">
                            <div class="d-flex align-items-center">
                                <span class="nav-link-icon">
                    ...
                    <div class="nav-item-wrapper">
                        <a class="nav-link label-1" href="<?php echo e(route('product.index')); ?>" role="button" data-bs-toggle="" aria-expanded="false">
                            <div class="d-flex align-items-center">
                                <span class="nav-link-icon">
                    ...
                    <div class="nav-item-wrapper">
                        <a class="nav-link label-1" href="<?php echo e(route('banners.index')); ?>" role="button" data-bs-toggle="" aria-expanded="false">
                            <div class="d-flex align-items-center">
                                <span class="nav-link-icon">
                    ...
                    <div class="nav-item-wrapper">
                        <a class="nav-link label-1" href="<?php echo e(route('videos.index')); ?>" role="button" data-bs-toggle="" aria-expanded="false">
                            <div class="d-flex align-items-center">
                                <span class="nav-link-icon">
                                    <span data-feather="calendar"></span>
                                </span>
                ...
                <li class="nav-item">
                    ...
                    <div class="nav-item-wrapper"><a class="nav-link label-1" href="widgets.html" role="button"
                            ...
                            <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                    ...
                                    class="nav-link-text-wrapper"><span class="nav-link-text">Widgets</span></span>
                            </div>
                        </a></div><!-- parent pages-->
                    <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1"
