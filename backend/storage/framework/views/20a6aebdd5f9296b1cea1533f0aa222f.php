...
<?php $__env->startSection('title', 'Quản lý tài khoản hệ thống'); ?>
<?php $__env->startSection('content'); ?>
    ...
    <div class="content">
        <h2 class="mb-2 lh-sm">Accounts Users</h2>
        <p class="text-body-tertiary lead mb-2">Quản lý tất cả tài khoản người dùng & phân quyền truy cập</p>
        <div class="mt-4">
            <div class="row g-4">
                            ...
                            <div class="card-header p-4 border-bottom bg-body">
                                <div class="row g-3 justify-content-between align-items-center">
                                    <div class="col-12 col-md">
                                        <h4 class="text-body mb-0" data-anchor="data-anchor">Accounts</h4>
                                    </div>
                                            ...
                                            <table class="table table-sm border-top border-translucent fs-9 mb-0">
                                                ...
                                                <tbody class="list" id="bulk-select-body">
                                                    <?php $__currentLoopData = $admins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $admin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr data-user-id="<?php echo e($admin->id); ?>">
                                                            ...
                                                            <td class="align-middle ps-3 name"><?php echo e($admin->name); ?></td>
                                                            <td class="align-middle email"><?php echo e($admin->email); ?></td>
                                                            <td class="align-middle age">
                                                                <?php echo e($admin->roles->pluck('name')->implode(', ')); ?></td>
                                                            </td>
                    ...
                    fetch(`/admin/edit/${userId}`)
                        ...
                        .then(data => {
                            ...
                            if (data.all_roles && data.all_roles.length > 0) {
                                const filteredRoles = data.all_roles.filter(role => role.name !== 'admin');
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\BookingApp–Laravel-React\backend\resources\views/apps/account/users/index.blade.php ENDPATH**/ ?>