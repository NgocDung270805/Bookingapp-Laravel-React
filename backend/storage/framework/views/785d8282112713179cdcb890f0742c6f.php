            ...
            <div class="row g-4">
                <div class="col-12 col-xxl-6">
                    ...
                    <div class="row align-items-center g-4">
                        <div class="col-12 col-md-auto">
                            <div class="d-flex align-items-center"><span class="fa-stack"
                                ...
                                <div class="ms-3">
                                    <h4 class="mb-0"><span
                                            data-stat="new_bookings"><?php echo e($stats['new_bookings'] ?? 0); ?></span> yêu cầu mới
                                    </h4>
                        ...
                        <div class="col-12 col-md-auto">
                            <div class="d-flex align-items-center"><span class="fa-stack"
                                ...
                                <div class="ms-3">
                                    <h4 class="mb-0"><span
                                            data-stat="pending_bookings"><?php echo e($stats['pending_bookings'] ?? 0); ?></span> yêu
                        ...
                        <div class="col-12 col-md-auto">
                            <div class="d-flex align-items-center"><span class="fa-stack"
                                ...
                                <div class="ms-3">
                                    <h4 class="mb-0"><span
                                            data-stat="out_of_stock"><?php echo e($stats['out_of_stock'] ?? 0); ?></span> sản phẩm</h4>
                    ...
                    <script>
                        ...
                        const loadBookingData = (filter = 'day') => { // **Thay đổi giá trị mặc định tại đây**
                            let bookingStats = {
                                'year': <?php echo json_encode($stats['bookings_by_year'], 15, 512) ?>,
                                'month': <?php echo json_encode($stats['bookings_by_month'], 15, 512) ?>,
                                'day': <?php echo json_encode($stats['bookings_by_day'], 15, 512) ?>
                            };
                            ...
                            bookingChart.setOption({
                                ...
                                series: [{
                                    ...
                                    type: 'line',
                                    data: data.values,
                                    smooth: false, // Giữ lại smooth: false như bạn đã sửa trước đó
                                    symbol: 'circle',
                            ...
                            <div class="card h-100">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            <h5 class="mb-1">Tổng số đơn(booking)
                                                ...
                                                <span
                                                    class="badge badge-phoenix badge-phoenix-<?php echo e($badgeType); ?> rounded-pill fs-9 ms-2">
                                                    <span
                                                        class="badge-label"><?php echo e($sign); ?><?php echo e($percentDisplay); ?></span>
                                                </span>
                                            </h5>
                                    ...
                                    <script>
                                        ...
                                        const rawBookingData = <?php echo json_encode($stats['bookings_last_7_days'], 15, 512) ?>;
                                        ...
                                        const barOption = {
                                            ...
                                            // >> ĐÃ CHỈNH SỬA: BẬT TOOLTIP VÀ THÊM FORMATTER <<
                                            tooltip: {
                                                trigger: 'item',
                                                backgroundColor: 'rgba(20, 20, 30, 0.9)',
                                                borderWidth: 0,
                                    ...
                                    <div class="mt-2">
                                        <div class="d-flex align-items-center mb-2">
                                            ...
                                            <h6 class="text-body fw-semibold mb-0">
                                                <?php echo e($stats['bookings_last_7_days_summary']->completed ?? 0); ?></h6>
                                        </div>
                                        <div class="d-flex align-items-center">
                                            <div class="bullet-item bg-primary-subtle me-2"></div>
                                            <h6 class="text-body fw-semibold flex-1 mb-0">Đang chờ xử lý</h6>
                                            <h6 class="text-body fw-semibold mb-0">
                                                <?php echo e($stats['bookings_last_7_days_summary']->pending ?? 0); ?></h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            <h5 class="mb-1">Khách hàng mới
                                                ...
                                                ?>
                                                <span
                                                    class="badge badge-phoenix badge-phoenix-<?php echo e($userBadgeType); ?> rounded-pill fs-9 ms-2">
                                                    <span
                                                        class="badge-label"><?php echo e($userSign); ?><?php echo e(number_format($userPercentChange, 1)); ?>%</span>
                                                </span>
                                            </h5>
                                            <h6 class="text-body-tertiary">7 ngày qua</h6>
                                        </div>
                                    ...
                                    <script>
                                        ...
                                        document.addEventListener('DOMContentLoaded', function() {
                                            ...
                                            const newUsersData = <?php echo json_encode($stats['new_users_by_day_last_7_days'], 15, 512) ?>;
                ...
                <div class="table-responsive mx-n1 px-1 scrollbar">
                    <table class="table fs-9 mb-0 border-top border-translucent">
                        ...
                        <tbody class="list" id="table-latest-review-body">
                            <?php $__currentLoopData = $stats['latest_comments']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                    ...
                                    <td class="align-middle product white-space-nowrap py-0"><a
                                            ...
                                            href="apps/e-commerce/landing/product-details.html"><img
                                                src="<?php echo e(asset('storage/' . $comment->product_image)); ?>" alt=""
                                                width="53" /></a>
                                    </td>
                                    <td class="align-middle product white-space-nowrap"><a class="fw-semibold"
                                            href="apps/e-commerce/landing/product-details.html"><?php echo e($comment->product_name); ?></a>
                                    </td>
                                    ...
                                    <td class="align-middle review" style="min-width:350px;">
                                        <p class="fs-9 fw-semibold text-body-highlight mb-0"><?php echo e($comment->content); ?></p>
                                    </td>
