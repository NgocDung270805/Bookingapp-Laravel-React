...
<?php $__env->startSection('title', 'Videos Management'); ?>
        ...
        <div class="mb-9">
            ...
            <ul class="nav nav-links mb-3 mb-lg-2 mx-n3">
                <li class="nav-item"><a class="nav-link active" aria-current="page" href="#"><span>All </span><span
                            class="text-body-tertiary fw-semibold" id="total-videos">(<?php echo e(count($videos)); ?>)</span></a></li>
            </ul>
            <div id="videos-list"
                                        ...
                                        <tr class="position-static">
                                            <td class="fs-9 align-middle">
                                                <div class="form-check mb-0 fs-8">
                                                    <input class="form-check-input" type="checkbox"
                                                        data-bulk-select-row='{"videoId":<?php echo e($video->id); ?>}' />
                                                </div>
                                            </td>
                                            <td class="align-middle white-space-nowrap py-0 video-thumb">
                                                <div class="position-relative" style="width: 160px; height: 90px;">
                                                    <?php if($video->img_banner): ?>
                                                        <img src="<?php echo e(asset('storage/' . $video->img_banner)); ?>"
                                                            alt=""
                                                            class="w-100 h-100 object-fit-cover rounded cursor-pointer"
                                                            onclick="playVideo('<?php echo e($video->video); ?>', '<?php echo e($video->name); ?>')" />
                                                    <?php else: ?>
                                            ...
                                            <td class="video-name align-middle ps-4">
                                                <a class="fw-semibold text-truncate mb-0" href="#"
                                                    onclick="playVideo('<?php echo e($video->video); ?>')">
                                                    <?php echo e($video->name); ?>

                                                </a>
                                            </td>
                                            <td class="video-categories align-middle ps-4">
                                                <?php if($video->categories->count() > 0): ?>
                                            ...
                                            <td class="video-description align-middle ps-4">
                                                <?php echo e(Str::limit($video->description, 100) ?? 'No description'); ?>
                                            ...
                                            <td class="video-status align-middle text-center ps-4">
                                                <div class="form-check form-switch d-flex justify-content-center">
                                                    <input class="form-check-input toggle-status" type="checkbox"
                                                        ...
                                                        <?php echo e($video->status ? 'checked' : ''); ?>>
                                                </div>
                                            </td>
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $('#videoForm').on('submit', function(e) {
                    ...
                    let url = method === 'POST' ? "<?php echo e(route('videos.store')); ?>" : `/videos/${videoId}`;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\BookingApp–Laravel-React\backend\resources\views/apps/video/index.blade.php ENDPATH**/ ?>