                            ...
                            <div class="row align-items-center gx-0 gy-7">
                                ...
                                <div class="col mx-auto">
                                    <div class="auth-form-box">
                                        ...
                                        <a href="<?php echo e(route('auth.facebook')); ?>" class="btn btn-phoenix-secondary w-100">
                                        ...
                                        <form action="<?php echo e(route('login.submit')); ?>" method="POST"> <?php echo csrf_field(); ?>
                                            <div class="mb-3 text-start">
                                                <label class="form-label" for="email">Email address</label>
                                                <div class="form-icon-container">
                                                    <input
                                                        class="form-control form-icon-input <?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?>"
                                                        ...
                                                        value="<?php echo e(old('email')); ?>" placeholder="name@gmail.com" />
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="mb-3 text-start">
                                                ...
                                                <div class="form-icon-container position-relative"
                                                    ...
                                                    <input
                                                        class="form-control form-icon-input pe-6 <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <script>// JS cho phần thông báo Login Google FB
...
<?php /**PATH C:\laragon\www\BookingApp–Laravel-React\backend\resources\views/pages/authentication/card/sign-in.blade.php ENDPATH**/ ?>