            ...
            <li class="nav-item dropdown">
                <a class="nav-link lh-1 pe-0" id="navbarDropdownUser" href="#!"
                    ...
                    <div class="avatar avatar-l ">
                        <img class="rounded-circle" src="<?php echo e(asset('storage/' . $user->profile?->avatar ?? 'https://static.vecteezy.com/system/resources/previews/020/429/953/non_2x/admin-icon-vector.jpg')); ?>"alt="Avatar" />
                    </div>
                </a>
                    ...
                    <div class="card position-relative border-0">
                        <div class="card-body p-0">
                            <div class="text-center pt-4 pb-3">
                                ...
                                <h6 class="mt-2 text-body-emphasis"><?php echo e($user->name); ?></h6>
                            </div>
...
<?php /**PATH C:\laragon\www\BookingApp–Laravel-React\backend\resources\views/partials/header.blade.php ENDPATH**/ ?>