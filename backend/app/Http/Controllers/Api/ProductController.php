    ...
    public function show($product_slug)
    {
        try {
            $product = Product::where('slug', $product_slug)
                                ->with('images', 'categories', 'tags', 'variants.attributeValues.attributeType', 'attributeValueConfigs.attributeValue.attributeType') // Đã sửa từ 'category' thành 'categories'
